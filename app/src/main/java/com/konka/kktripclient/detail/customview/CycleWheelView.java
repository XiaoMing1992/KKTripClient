...
public class CycleWheelView extends ListView {
     ...
     * Gradual Alph
     */
    private float mAlphaGradual = 0.8f;
    ...
    private void init() {
        ...
        mItemLayoutId = R.layout.write_item_cyclewheel;
...
//                double alpha = Math.pow(mAlphaGradual, delta);
                double alpha = mAlphaGradual-delta*0.1f;
    ...
    private void initView() {
        ...
        Drawable backgroud = new Drawable() {
            ...
            public void draw(Canvas canvas) {
                ...
                //绘制圆角矩形
                RectF r2=new RectF(0,mItemHeight * (mWheelSize / 2),viewWidth,mItemHeight* (mWheelSize / 2 + 1));
                canvas.drawRoundRect(r2, 6, 6, seletedSolidPaint);
