...
/**
 * Created by Zhou Weilin on 2017-6-1.
 * 系统中自带的RatingBar使用起来非常不方便，并且无法调整合适大小间距等，于是自定义一个可自己调节星星数量，大小，间距等属性的RatingBar
 */
...
public class RatingBar extends LinearLayout {
    ...
    public RatingBar(Context context, AttributeSet attrs) {
        ...
        TypedArray mTypedArray = context.getApplicationContext().obtainStyledAttributes(attrs, R.styleable.RatingBar);
